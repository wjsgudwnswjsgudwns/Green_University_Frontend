...
const SubjectList = () => {
  ...
  const fetchSubjectList = async (page) => {
    try {
      ...
      const response = await api.get(`/api/sugang/subjectList/${page}`);
      const data = response.data;

      console.log("API 응답:", data);
      console.log("받은 subjectList 개수:", data.subjectList?.length);
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await api.get("/api/sugang/subjectList/search", {
        params: searchParams,
      });
      const data = response.data;

      console.log("검색 API 응답:", data);
      console.log("검색 결과 개수:", data.subjectList?.length);
        ...
        <div className="sub--menu--mid">
          <table className="sub--menu--table">
            <tbody>
              <tr>
                <td>
                  <a href="/sugang/subjectList" className="selected--menu">
                    강의 시간표 조회
                  </a>
                </td>
              </tr>
