...
function ProfessorCounselingPage() {
  ...
  const handleToggleEditMode = () => {
    if (editMode) {
      ...
      if (detailBackup) {
        ...
        setSelectedReservation(detailBackup.selectedReservation || null);
  ...
  const handleSelectReservationFromList = (reservation) => {
    ...
    const slotStart = reservation.slotStartAt ?? reservation.startAt ?? null;
      ...
      <section className="pcp-schedule-detail-section">
        ...
        <div className="pcp-schedule-container">
          <div className="pcp-schedule-header">
            ...
            <button
              type="button"
              className={`pcp-edit-toggle-btn ${editMode ? "active" : ""}`}
