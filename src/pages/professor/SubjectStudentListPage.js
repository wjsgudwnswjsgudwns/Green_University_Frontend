        ...
        const fetchStudentList = async () => {
            try {
                ...
                students.forEach((student) => {
                    ...
                    const defaultGrade = student.currentGrade || 
                        (student.recommendedGrade ? 
                            (student.recommendedGrade === "A" ? "A+" : 
                             student.recommendedGrade === "B" ? "B+" : 
                             student.recommendedGrade === "C" ? "C+" : 
            ...
            <main>
                ...
                >
                    ...
                    <p className="policy-note">
                        * 기본값: 10/30/30/30, 지각 {policy.latenessPerAbsent}회=1결석, 지각 {policy.latenessFreeCount}회까지 무감점, 이후 회당 {policy.latenessPenaltyPer}점 감점, 결석 4회 이상 F
                    </p>
                </form>
                        ...
                        <table border="1" className="sub--list--table">
                            ...
                            <tbody>
                                {studentList.map((student) => {
                                    ...
                                    const currentGrade = formData.grade || student.recommendedGrade || "C+";
                                                ...
                                                <td>
                                                    {student.currentGrade ? (
                                                        <span className="current-grade-display">
                                                            {student.currentGrade} ({gradeToGPA(student.currentGrade).toFixed(1)})
                                                        </span>
                                                    ) : (
                                            ...
                                            {expandedForms[student.studentId] && (
                                                <tr>
                                                    <td colSpan={12} className="student-form-cell">
                                                        <div
                                                            ref={(el) => (formRefs.current[student.studentId] = el)}
                                                            className="student-grade-form"
                                                        >
                                                            <h4>{student.studentName} ({student.studentId}) 성적 입력</h4>
                                                            <form
                                                                onSubmit={(e) => handleSubmit(student.studentId, e)}
                                                            >
                                                                <div className="form-grid">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "absent", e.target.value)}
                                                                            min="0"
                                                                        />
                                                                        <span className="form-note">※ 결석 4회 이상시 F학점입니다.</span>
                                                                    </div>
                                                                    <div className="form-group">
                                                                        <label>지각</label>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "lateness", e.target.value)}
                                                                            min="0"
                                                                        />
                                                                        <span className="form-note" style={{ color: 'transparent' }}>※</span>
                                                                    </div>
                                                                    <div className="form-group">
                                                                        <label>과제점수</label>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "homework", e.target.value)}
                                                                            min="0"
                                                                            step="0.1"
                                                                        />
                                                                        <span className="form-note" style={{ color: 'transparent' }}>※</span>
                                                                    ...
                                                                    <div className="form-group">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "midExam", e.target.value)}
                                                                            min="0"
                                                                            step="0.1"
                                                                        />
                                                                        <span className="form-note" style={{ color: 'transparent' }}>※</span>
                                                                    ...
                                                                    <div className="form-group">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "finalExam", e.target.value)}
                                                                            min="0"
                                                                            step="0.1"
                                                                        />
                                                                    </div>
                                                                    <div className="form-group">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            onChange={(e) => handleFormChange(student.studentId, "grade", e.target.value)}
                                                                        >
                                                                ...
                                                                <div className="form-actions">
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => toggleForm(student.studentId)}
                                                                    ...
                                                                    >
                                                                        {submitting[student.studentId] ? "제출 중..." : "제출하기"}
                                                                    </button>
                                                                </div>
                                                            </form>
                                                        </div>
